...
app_path="${1:-src-tauri/target/release/bundle/macos/gogoke.app}"
...
bin_path="${app_path}/Contents/MacOS/gogoke"
daemon_path="${app_path}/Contents/MacOS/gogoke_daemon"
daemonctl_path="${app_path}/Contents/MacOS/gogoke_daemonctl"
daemon_source="${DAEMON_BINARY_PATH:-src-tauri/target/release/gogoke_daemon}"
daemonctl_source="${DAEMONCTL_BINARY_PATH:-src-tauri/target/release/gogoke_daemonctl}"
