    ...
    <PopoverSurface className="file-preview-popover" style={style}>
      <div className="file-preview-header">
        <div className="file-preview-title">
          ...
          {truncated && (
            <span className="file-preview-warning">{tx("Truncated")}</span>
          )}
        </div>
        <button
          type="button"
          ...
          title={tx("Close preview")}
        >
          <X size={14} aria-hidden />
        </button>
      </div>
      {isLoading ? (
        <div className="file-preview-status">{tx("Loading file...")}</div>
      ) : error ? (
          ...
          <div className="file-preview-toolbar">
            <div className="file-preview-selection-group">
              ...
              {selectionHints.length > 0 ? (
                <div className="file-preview-hints" aria-label={tx("Selection hints")}>
