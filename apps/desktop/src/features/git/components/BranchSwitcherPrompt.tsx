  ...
  return (
    ...
    >
      <input
        ...
        placeholder={tx("Search branches...")}
      />
      <BranchList
        ...
        renderMeta={(branch) => {
          ...
          return (
            <span className="branch-switcher-modal-item-meta">
              {isCurrent && (
                <span className="branch-switcher-modal-item-current">{tx("current")}</span>
              )}
              {worktree && (
                <span className="branch-switcher-modal-item-worktree">{tx("worktree")}</span>
              )}
            </span>
          );
        }}
