...
describe("Markdown file-like href behavior", () => {
  ...
  it("still intercepts dotless workspace file hrefs when a file opener is provided", () => {
    ...
    render(
      <Markdown
        value="See [license](/workspace/gogoke/LICENSE)"
        className="markdown"
        workspacePath="/Users/sotiriskaniras/Documents/Development/Forks/gogoke"
        onOpenFileLink={onOpenFileLink}
      />,
    );

    const link = screen.getByText("license").closest("a");
    expect(link?.getAttribute("href")).toBe("/workspace/gogoke/LICENSE");
    ...
    fireEvent(link as Element, clickEvent);
    expect(clickEvent.defaultPrevented).toBe(true);
    expectOpenedFileTarget(onOpenFileLink, "/workspace/gogoke/LICENSE");
  });
  ...
  it("still intercepts nested workspace file hrefs when a file opener is provided", () => {
    ...
    render(
      <Markdown
        value="See [src](/workspaces/team/gogoke/src)"
        className="markdown"
        workspacePath="/Users/sotiriskaniras/Documents/Development/Forks/gogoke"
        onOpenFileLink={onOpenFileLink}
      />,
    ...
    expect(link?.getAttribute("href")).toBe("/workspaces/team/gogoke/src");
    ...
    fireEvent(link as Element, clickEvent);
    expect(clickEvent.defaultPrevented).toBe(true);
    expectOpenedFileTarget(onOpenFileLink, "/workspaces/team/gogoke/src");
  });
  ...
  it("intercepts Windows absolute file hrefs with #L anchors and preserves the tooltip", () => {
    ...
    const linkedPath =
      "I:\\gpt-projects\\gogoke\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx#L422";
    render(
      <Markdown
    ...
    expect(link?.getAttribute("href")).toBe(
      "I:%5Cgpt-projects%5Cgogoke%5Csrc%5Cfeatures%5Csettings%5Ccomponents%5Csections%5CSettingsDisplaySection.tsx#L422",
    );
    expect(link?.getAttribute("title")).toBe(
      "I:\\gpt-projects\\gogoke\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx:422",
    );
    ...
    expectOpenedFileTarget(
      onOpenFileLink,
      "I:\\gpt-projects\\gogoke\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx",
      422,
    );
    ...
    expect(onOpenFileLinkMenu).toHaveBeenCalledWith(
      expect.anything(),
      {
        path: "I:\\gpt-projects\\gogoke\\src\\features\\settings\\components\\sections\\SettingsDisplaySection.tsx",
        line: 422,
        column: null,
      },
    );
