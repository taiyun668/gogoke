...
describe("Messages", () => {
  ...
  it("routes markdown href file paths through the file opener", () => {
    const linkedPath =
      "/Users/gogo-party/Documents/Dev/gogoke/src/features/messages/components/Markdown.tsx:244";
    const items: ConversationItem[] = [
      {
    ...
    expectOpenedFileTarget(
      openFileLinkMock,
      "/Users/gogo-party/Documents/Dev/gogoke/src/features/messages/components/Markdown.tsx",
      244,
    );
  });
  ...
  it("routes absolute href file paths with #L anchors through the file opener", () => {
    const linkedPath =
      "/Users/gogo-party/Documents/Dev/gogoke/src/features/messages/components/Markdown.tsx#L244";
    const items: ConversationItem[] = [
      {
  ...
  it("routes dotless workspace href file paths through the file opener", () => {
    const linkedPath = "/workspace/gogoke/LICENSE";
    const items: ConversationItem[] = [
      {
    ...
    render(
      <Messages
        ...
        threadId="thread-1"
        workspaceId="ws-1"
        workspacePath="/Users/example/Projects/gogoke"
        isThinking={false}
        openTargets={[]}
        selectedOpenAppId=""
      />,
  ...
  it("renders absolute file references as workspace-relative paths", () => {
    const workspacePath = "/Users/gogo-party/Documents/Dev/gogoke";
    const absolutePath =
      "/Users/gogo-party/Documents/Dev/gogoke/src/features/messages/components/Markdown.tsx:244";
    const items: ConversationItem[] = [
      {
  ...
  it("renders absolute file references outside workspace using dotdot-relative paths", () => {
    const workspacePath = "/Users/gogo-party/Documents/Dev/gogoke";
    const absolutePath = "/Users/gogo-party/Documents/Other/IceCubesApp/file.rs:123";
    const items: ConversationItem[] = [
      {
    ...
    expectOpenedFileTarget(
      openFileLinkMock,
      "/Users/gogo-party/Documents/Other/IceCubesApp/file.rs",
      123,
    );
  });
