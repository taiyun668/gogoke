...
export function decodePublicObject(bytes: Uint8Array): DecodedPublicObject {
  ...
  if (typeof raw.objectType !== "string" || !hasOwn(OBJECT_DEFINITIONS, raw.objectType)) {
